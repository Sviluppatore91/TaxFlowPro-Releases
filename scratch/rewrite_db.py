...
class DatabaseHelper {
  ...
  static Future<String> getDatabasePath() async {
    ...
    return p.join(directory.path, 'taxflowpro_backup.db');
  }
...
with open("c:/Users/Hp/Documents/Sviluppo/contabile/contabile_app/lib/database/database_helper.dart", "w", encoding="utf-8") as f:
    f.write(dart_code)

print("DatabaseHelper refactored successfully.")
