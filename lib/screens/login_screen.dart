    ...
    try {
      ...
      if (authenticated) {
        ...
        if (savedEmail != null && savedPassword != null) {
          ...
          setState(() {
            _errorMessage = 'Nessuna credenziale salvata. Fai il login spuntando Ricorda.';
          });
        }
      }
    } catch (e) {
    ...
    return Row(
      ...
      children: [
        ...
        _buildFooterIcon(
          ...
          popupDesc: 'Fatturazione, monitoraggio, statistiche predittive: TaxFlowPro è progettato con moduli intelligenti per aiutarti a ottimizzare il flusso fiscale.',
          isDesktop: isDesktop
        ),
      ],
    );
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'TaxFlow Pro è l\'app completa per la gestione della tua\nattività: fatture, clienti, spese, scadenze e molto altro.\nSempre con te, sempre aggiornato.',
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Accedi al tuo account per\ngestire la tua attività in modo semplice.',
                style: TextStyle(color: Colors.white.withValues(alpha: 0.6), fontSize: 15, height: 1.5),
              ),
              const SizedBox(height: 32),
              _buildForm(),
